...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Мария Винникова\\Pictures\\Стимулы для экспов с ЭКП\\буквенный массив\\LandT\\current\\stimuli_generated_200\\exp_let_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    practice_trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('test_phase_200 - Sheet1.csv'), 
        seed=None, 
    )
    ...
    main_phase = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('main_trials_200 - Sheet1.csv'), 
        seed=None, 
    )
    ...
    recognition = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('recog_phase - Sheet1.csv'), 
        seed=None, 
    )
